...
ALLOWED_HOSTS = ['192.168.0.170', 'localhost', '127.0.0.1', '.yurack.com']
...
# Confiar en las peticiones que vienen de tu dominio seguro
CSRF_TRUSTED_ORIGINS = ['https://mithoworld.yurack.com']
